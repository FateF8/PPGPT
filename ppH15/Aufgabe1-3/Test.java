...
public class Test {
    ...
    public static void main(String[] args) {
        ...
        -Regen und Wind hinzugefügt. Der Regen schwächt alle Duftspuren ab und die Ameisen flüchten sofort zum Bau
         zurück, da sie unter diesen Bedingungen keine Straßen bilden können.
        Der Wind kann je nach Stärke die Futterquellen und Hindernisse verschieden weit verschieben.
        -Verbesserung Aufgabe 1: Hashmap um switch cases in neighborsOffset zu vermeiden, graphische Ausgabe
         hochskaliert, Verbesserung vom foraging und explore Zustand

        Yi:
        -Tag-Nacht-Zyklus hinzugefügt, wobei die Ameisen ab 22Uhr, je nach Entfernung anfangen zurück zum Bau zu gehen.
        -Alter hinzugefügt, wobei die älteren Ameisen nahezu perfekt zum Bau finden und die jüngeren einen recht
         schlechten Weg gehen.
        ...
        Julian:
        -Erweiterung um funktionalen Teil: Eine andere Insektenart wurde hinzugefügt. Diese nimmt ähnliche Nahrung
         wie die Ameisen zu sich und frisst daher gelegentlich den Ameisen die Nahrung weg. Sie sind größer und
         können daher auch von weit weg die Nahrung sehen und kommen ohne große Umwege zur Quelle.
        -Geholfen Design by Contract Kommentare zu schreiben.

        Yi:
        -Um kleinen parallelen Teil ergänzt -> Ameisen bewegen sich parallel und werden auch parallel gezeichnet
        -Kleine Bugfixes und einpaar Design by Contract Kommentare geschrieben/ergänzt.

        Lucy:
        - Beschreibung von GOOD und BAD im objektorientierten und prozeduralen Teil
        - Hinzufügen von Kommentaren nach Design by Contract
        ...
        Obstacle obstacle = new Obstacle(10,10,testcd);
        obstacle.setLevel(0);
        ...
        while(true) {
            simulation1.simulateAndDraw();
            simulation2.simulateAndDraw();
            simulation3.simulateAndDraw();
        }
    }
